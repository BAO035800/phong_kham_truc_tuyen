...
class BacSiController
{
    ...
    public function __construct()
    {
        ...
        // KHÔNG set header CORS/Content-Type ở đây. public/index.php đã lo.
    }
    ...
    public function handleRequest(): array
    {
        ...
        switch ($method) {
            ...
            case 'PUT':
                ...
                http_response_code(200);
                return ['status'=>'ok','message'=>'Cập nhật bác sĩ thành công'];

            case 'DELETE':
                if ($id === null) { http_response_code(400); return ['status'=>'error','message'=>'Thiếu id']; }
                $this->model->delete($id);
                http_response_code(200);
                return ['status'=>'ok','message'=>'Xóa bác sĩ thành công'];
